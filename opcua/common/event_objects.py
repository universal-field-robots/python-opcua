...
from opcua.ua.uaprotocol_auto import ModelChangeStructureDataType
...
class GeneralModelChangeEvent(BaseModelChangeEvent):
    ...
    def __init__(self, sourcenode=None, message=None, severity=1):
        ...
        # self.add_property('Changes', ModelChangeStructureDataType(), ua.NodeId(ua.ObjectIds.ModelChangeStructureDataType))
        self.add_property('Changes', ModelChangeStructureDataType(), VariantType.ExtensionObject)
